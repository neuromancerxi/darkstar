...
local TI_Alchemy = {937,4157,4163,947,16543,4116,16479,4120,16609,10792}; -- Saida Ring
local TI_Bonecraft = {13442,13441,13323,13459,13091,17299,16420,12508,13987,11058}; --  Way of The Boneworker + Hajduk Ring
local TI_Clothcraft = {13583,13584,13204,13075,12723,13586,13752,12612,14253,11000}; -- Swith Cape
